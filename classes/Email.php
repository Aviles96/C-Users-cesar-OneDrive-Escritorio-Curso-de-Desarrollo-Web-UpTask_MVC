...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</stong> Has Creado tu cuenta en UpTask, 
        solo debes confirmar en el siguiente enlace</p>";
    ...
    public function enviarInstrucciones() {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</stong> Parece que has olvidado tu password,
